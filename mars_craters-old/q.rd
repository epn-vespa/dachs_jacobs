...
<!--
<var key="s_region">pgsphere.SCircle(pgsphere.SPoint.fromDegrees(360-@c1min,@c2min),(@diameter/(2.0*math.pi*3390.0/180.0))*pgsphere.DEG).asPoly().asSTCS("UNKNOWNFrame")</var>
